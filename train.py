...
def train(hyp, opt, device, tb_writer=None):
    ...
    dataloader, dataset = create_dataloader(train_path, imgsz, batch_size, gs, opt,
                                            ...
                                            image_weights=opt.image_weights, quad=opt.quad, prefix=colorstr('train: '),kpt_label=kpt_label,kpt_num=kpt_num)
    ...
    if rank in [-1, 0]:
        testloader = create_dataloader(test_path, imgsz_test, batch_size * 2, gs, opt,  # testloader
                                       ...
                                       world_size=opt.world_size, workers=opt.workers,
                                       pad=0.5, prefix=colorstr('val: '), kpt_label=kpt_label,kpt_num=kpt_num)[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolov5s6_pose_640pre.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/hub/yolov5s6_kpts.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/work.yaml', help='data.yaml path')
    ...
    parser.add_argument('--kpt-label', action='store_false', help='use keypoint labels for training')
