...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='../yolov5s6_pose_640.pt', help='weights path')
    ...
    parser.add_argument('--export-nms', default='true', help='export the nms part in ONNX model')
    ...
    img = cv2.imread("../data/images/woman.jpg")
