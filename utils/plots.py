...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=640, max_subplots=16, kpt_label=True, kpt_num = 5,steps=2, orig_shape=None):
    ...
    for i, img in enumerate(images):
        ...
        if len(targets) > 0:
            ...
            labels = image_targets.shape[1] == (6+kpt_num *2 ) if kpt_label else image_targets.shape[1] == 6  # labels if no conf column
